...
reply_link = "https://ogusers.com/xxxxxxxx"
...
def replyfunction():
    ...
    while i != total_messages:
        ...
        try:
            driver.find_element(By.XPATH,"//*[@class='sceditor-button sceditor-button-code']").click()
            text_box = driver.find_element(By.ID,"code")
            ...
            for letter in message:
                ...
                time.sleep(wait_time)
            driver.find_element(By.CSS_SELECTOR,'[value="Insert"]').click()
            time.sleep(0.5)
